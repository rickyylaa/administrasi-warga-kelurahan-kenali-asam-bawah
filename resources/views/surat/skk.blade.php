...
<body>
    ...
    <div class="detail">
        ...
        <p>Nomor : SKK/ {{ date('Y') }}</p>
    </div>
    <div class="content">
        <p>Yang bertanda tangan di bawah ini, Lurah Kenali Asam Bawah Menerangkan dengan sesungguhnya, bahwa :</p>
        <dl>
            <dt>Nama</dt>
        ...
        <p>Adalah benar warga Kelurahan Kenali Asam Bawah Kecamatan Kota Baru Kota Jambi dan yang bersangkutan <b>Telah Meninggal Dunia</b> pada hari ___ tanggal ___ jam ___ WIB di Kelurahan Kenali Asam Bawah Kecamatan Kota Baru Kota Jambi serta dimakamkan di pemakaman umum (TPU) Kelurahan Kenali Asam Bawah.</p>
