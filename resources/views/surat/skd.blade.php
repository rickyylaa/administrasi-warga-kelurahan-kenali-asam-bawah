...
<body>
    ...
    <div class="detail">
        ...
        <p>Nomor : SKD/ {{ date('Y') }}</p>
    </div>
    <div class="content">
        <p><strong>Yang bertanda tangan di bawah ini :</strong></p>
        <dl>
            <dt>Nama</dt>
            <dd>: Ronal Amson, SE</dd>
        </dl>
        <dl>
            <dt>Jabatan</dt>
            <dd>: Lurah</dd>
        </dl>
        <p style="margin-top: 0px;"><strong>Menerangkan Bahwa :</strong></p>
        <dl>
            <dt>Nama</dt>
        ...
        <p>Yang bersangkutan benar-benar berdomisili di Kelurahan Kenali Asam Bawah Kecamatan Alam Barajo Kota Jambi sejak tanggal {{ \Carbon\Carbon::now()->locale('id')->translatedFormat('d F Y') }}.</p>
